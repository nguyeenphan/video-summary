...
export interface ComponentsFeture extends Struct.ComponentSchema {
  collectionName: 'components_components_fetures';
  info: {
    displayName: 'Feature';
  };
  attributes: {
...
export interface LayoutFeaturesSection extends Struct.ComponentSchema {
  ...
  attributes: {
    ...
    features: Schema.Attribute.Component<'components.feture', true>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ComponentSchemas {
      'components.feture': ComponentsFeture;
